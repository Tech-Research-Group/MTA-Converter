...
from tkinter import Button, Entry, filedialog, Frame, Label, messagebox, Text
...
def open_file():
    ...
    if path != "":
        print("Excel file located at: " + path)
...
def convert_file(path):
    ...
    try:
        ...
        if _wp > _sh.max_row:
            ...
            txt_output.insert("1.0", "Initial Setup Box:\n\nTest Equipment:\n\n")
...
txt_row = Entry(frame1, width=10, font='Helvetica 12', bg="#FFFFFF", fg="#000000")
